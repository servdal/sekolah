<p align="center"><a href="https://duidev.com" target="_blank"><img src="https://github.com/servdal/sekolah/blob/master/public/dist/img/logokecil.png" width="400"></a></p>

<p align="center">
<a href="https://amil.sdimohammadhatta.sch.id"><img src="https://duidev.com/logo/1602884372logo.png" width="35" alt="SDI Mohammad Hatta Malang"></a>
...
8. Jalankan perintah `php artisan config:cache`.
9. Jalankan perintah `php artisan migrate`.
10. Jalankan perintah `php artisan db:seed`.
11. Akses aplikasi melalui browser Anda (Username dan Password Default : admin@swandhana.test | semangat).
...
### ☕ Dukung Pengembangan
Jika bermanfaat bagi Anda, silakan berdonasi untuk mendukung pengembangan selanjutnya.
