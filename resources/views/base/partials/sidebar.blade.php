    ...
    <section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			@if(Session('previlage') == 'level1')
				...
				<li class="treeview">
					<a href="#"><i class="fa fa-graduation-cap text-blue"></i><span>Guru</span><i class="glyphicon glyphicon-chevron-left pull-right"></i></a>
					<ul class="treeview-menu">
						...
						<li class="treeview">
							<a href="#"><i class="fa fa-star text-blue"></i><span>Kurikulum</span><i class="glyphicon glyphicon-chevron-left pull-right"></i></a>
							<ul class="treeview-menu">
						...
						@if(Session('sekolah_level') == 1)
							<li class="treeview">
								<a href="#"><i class="fa fa-star text-blue"></i><span>Kelompok Belajar</span><i class="glyphicon glyphicon-chevron-left pull-right"></i></a>
								<ul class="treeview-menu">
			...
			@if(Session('spesial') == 'paguyuban')
				<li class="{{ isset($sidebar) && $sidebar == 'dashboardpaguyuban' ? 'active' : '' }}"><a href="{{ url('dashboardpaguyuban') }}"><i class="fa fa-users text-red"></i> <span>Paguyuban Zone</span></a></li>
			@endif
			@if(Session('id'))
				<li><a href="{{ route('logout') }}"><i class="fa fa-sign-out text-magenta"></i><span>Logout</span></a></li>
			@else
				@if (isset($id_sekolah))
