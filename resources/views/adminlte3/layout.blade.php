...
<html>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                ...
                                @php
                                    ...
                                    foreach($notifications as $notification){
                                        ...
                                        echo '<div class="media dropdown-item"><i class="fa fa-comments-o mr-2"></i><p>'.$message.'</p></div>';
                                    }
                                @endphp
                                <div class="dropdown-divider"></div>
                        ...
                        <li class="nav-item dropdown user-menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                ...
                                <li class="user-footer">
                                    <button id="btnclearnotifikasi" class="btn btn-default btn-flat">Bersihkan Notifikasi</button>
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <a href="{{url('/')}}" class="brand-link">
                    <img src="@if (Session('sekolah_logo') !== null){{ url('/').'/'.Session('sekolah_logo') }}@else{{ asset('logo.png') }}@endif" alt="Duidev Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light">
                    @if (Session('sekolah_nama_sekolah') !== null)
                        {{ Session('sekolah_nama_sekolah') }}
                    @else
                        {{ config('global.sekolah') }}
                    @endif
                    </span>
            ...
            <div class="content-wrapper">
                @yield('content')
                <input type="hidden" id="teksnotifikasi" value="lama">
            </div>
        ...
        <script type="text/javascript">
            ...
            $("#btnclearnotifikasi").click(function(){
                var form_data = new FormData();
                    form_data.append('val02', 'notifikasi');
                    form_data.append('val01', document.getElementById('teksnotifikasi').value);
                    form_data.append('_token', '{{csrf_token()}}');
                $.ajax({
                    url         : '{{route("exDestroyer")}}',
                    data        : form_data,
            ...
            $("#btnclearnotifikasi").click();
            $('#teksnotifikasi').val('all');
        </script>
    </body>
</html>