...
<html>
    <head>
        ...
        <!-- App favicon -->
        <link rel="icon" href="@if (isset($logo01)){{ $logo01 }}@else{{ asset('duidev-softwarehouse.png') }}@endif">
        <link rel="apple-touch-icon" href="@if (isset($logo01)){{ $logo01 }}@else{{ asset('duidev-softwarehouse.png') }}@endif">
        <!-- App css -->
