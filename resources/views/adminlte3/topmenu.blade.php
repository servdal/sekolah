        ...
        <ul aria-labelledby="suratmenu" class="dropdown-menu border-0 shadow">
                    ...
                    <li class="dropdown-submenu dropdown-hover">
                        ...
                        <ul aria-labelledby="groupruangguru" class="dropdown-menu border-0 shadow">
                            ...
                            @if(Session('sekolah_level') == 1)
                                <li class="dropdown-submenu dropdown-hover">
                                    <a id="groupmenukelastaa" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Tahap 1</a>
                                    <ul aria-labelledby="groupmenukelastaa" class="dropdown-menu border-0 shadow">
                                        <li><a class="dropdown-item" href="{{ url('tahap/1A') }}">TA 1-A</a></li>
                                        <li><a class="dropdown-item" href="{{ url('tahap/1B') }}">TA 1-B</a></li>
                                        <li><a class="dropdown-item" href="{{ url('tahap/1C') }}">TA 1-C</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu dropdown-hover">
                                    <a id="groupmenukelastaa" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Tahap 2</a>
                                    <ul aria-labelledby="groupmenukelastaa" class="dropdown-menu border-0 shadow">
                                        <li><a class="dropdown-item" href="{{ url('tahap/2A') }}">TA 2-A</a></li>
                                        <li><a class="dropdown-item" href="{{ url('tahap/2B') }}">TA 2-B</a></li>
                                        <li><a class="dropdown-item" href="{{ url('tahap/2C') }}">TA 2-C</a></li>
                                    </ul>
                                </li>
                                <!--
                                <li class="dropdown-submenu dropdown-hover">
            ...
            <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="groupkesiswaan" class="dropdown-menu border-0 shadow">
                    ...
                    <li><a class="dropdown-item" href="{{ url('rencanakegiatan') }}">Rencana Kegiatan Tahunan</a></li>
                    ...
                    <li><a class="dropdown-item" href="{{ url('beasiswa') }}">Laporan Beasiswa</a></li>
            ...
            <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="groupkesiswaan" class="dropdown-menu border-0 shadow">
                    ...
                    <li><a class="dropdown-item" href="{{ url('logkeuangan') }}">Laporan Perubahan Data Keuangagn</a></li>
                </ul>
            </li>
            <li class="dropdown-submenu dropdown-hover">
                <a id="groupkesiswaan" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Umum</a>
                <ul aria-labelledby="groupkesiswaan" class="dropdown-menu border-0 shadow">
...
@elseif(Session('previlage') == 'Waka Kurikulum')
    ...
    <li class="nav-item dropdown">
        <a id="suratmenu" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Kesiswaan</a>
        <ul aria-labelledby="suratmenu" class="dropdown-menu border-0 shadow">
            <li><a class="dropdown-item" href="{{ url('rencanakegiatan') }}">Rencana Kegiatan Tahunan</a></li>
            <li><a class="dropdown-item" href="{{ url('pengumuman') }}">Pengumuman</a></li>
        </ul>
    ...
    <li class="nav-item dropdown">
        <a id="groupruangguru" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Ruang Guru</a>
        <ul aria-labelledby="groupruangguru" class="dropdown-menu border-0 shadow">
            <li><a class="dropdown-item" href="{{ url('setrps') }}">Kurikulum</a></li>
            <li><a class="dropdown-item" href="{{ url('banksoal') }}">Bank Soal</a></li>
            <li><a class="dropdown-item" href="{{ url('lognilai') }}"> Log Perubahan Nilai</a></li>
...
@elseif(Session('previlage') == 'Waka Kurikulum Al Quran')
    ...
    <li class="nav-item dropdown">
        <a id="mainmenu" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Main Menu</a>
        <ul aria-labelledby="mainmenu" class="dropdown-menu border-0 shadow">
            <li><a class="dropdown-item" href="{{ url('prestasialquran') }}">Kurikulum Alquran</a></li>
        </ul>
    </li>
    <li class="nav-item dropdown">
        <a id="suratmenu" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Kesiswaan</a>
...
@elseif(Session('previlage') == 'level2')
    ...
    <li class="nav-item dropdown">
        <a id="groupmenuguru" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Kesiswaan</a>
...
@elseif(Session('previlage') == 'level4')
        ...
        <ul aria-labelledby="suratmenu" class="dropdown-menu border-0 shadow">
            ...
            <li class="dropdown-submenu dropdown-hover">
                ...
                <ul aria-labelledby="groupkesiswaan" class="dropdown-menu border-0 shadow">
                    ...
                    <li><a class="dropdown-item" href="{{ url('beasiswa') }}">Laporan Beasiswa</a></li>
                    <li><a class="dropdown-item" href="{{ url('prestasisiswa') }}">Laporan Prestasi Siswa</a></li>
                    <li><a class="dropdown-item" href="{{ url('presensifinger') }}">Presensi Finger</a></li>
                </ul>
            </li>
            <li class="dropdown-submenu dropdown-hover">
                <a id="groupkesiswaan" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Umum</a>
    ...
    <li class="nav-item dropdown">
        <a id="groupmenusetting" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Setting</a>
        <ul aria-labelledby="groupmenusetting" class="dropdown-menu border-0 shadow">
            <li><a class="dropdown-item" href="{{ url('useranyar') }}"> Account Staf</a></li>
            <li><a class="dropdown-item" href="{{ url('pengumuman') }}"> Pengumuman</a></li>
            <li><a class="dropdown-item" href="{{ url('setting') }}">Setting</a></li>
        </ul>
    </li>
...
@elseif(Session('previlage') == 'Guru AlQuran')
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ url('prestasialquran') }}" role="button"> Alquran</a>
    </li>
@elseif(Session('previlage') == 'ortu')
    ...
    <li class="nav-item dropdown">
        ...
        <ul aria-labelledby="groupmenuortu" class="dropdown-menu border-0 shadow">
            <li><a class="dropdown-item" href="{{ url('biodata') }}">Data Siswa</a></li>
            <li><a class="dropdown-item" href="{{ url('ijinortu') }}">Presensi Harian</a></li>
            <li><a class="dropdown-item" href="{{ url('lapnilaiortu') }}">Laporan Nilai</a></li>
            <li><a class="dropdown-item" href="{{ url('faqihkecil') }}">Halaqoh AlQuran</a></li>
...
@if (Session('previlage') == 'ortu')
    <li class="nav-item">
        <a class="nav-link" href="{{ url('wbs') }}" role="button"> WBS</a>
    </li>
@endif